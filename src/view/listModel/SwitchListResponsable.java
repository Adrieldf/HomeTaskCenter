...
public class SwitchListResponsable extends JPanel{
	
	private JList list1, list2;
	private JButton bPuttOne, bPuttAll, bRemoveOne, bRemoveAll;
	private JScrollPane slist1, slist2;
	
	public SwitchListResponsable() {
		
		super(new GridLayout(1,3));
		list1 = new JList(new ResponsableListModel());
		...
		list2 = new JList(new ResponsableListModel());
